...
class Game(object):
    ...
    def get_history(self):
        return self.__board_record_list
    ...
    # 根据传参信息初始化棋盘
    def __setup_board(self, info: dict,board_record, game_info):
        self.__board = info["board"]
        self.__red = info["red_num"]
        self.__blue = info["blue_num"]
        self.__board_record_list = board_record
        self.__game_info_list = game_info
